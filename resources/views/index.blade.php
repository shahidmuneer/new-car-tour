...
<head>
    ...
    <style type="text/css">
        ...
        /*]]>*/
            @font-face {
            font-family: "excelarate";
            src: url("/fonts/excelatel.ttf");
            }
            @font-face{
                font-family:"Blazed";
            ...
            @font-face{
                ...
                src:url("/fonts/americorps.ttf");
            }
            @font-face{
                font-family:"StreetRacingDemoRegular";
                src:url("/fonts/StreetRacingDemoRegular.ttf");
            }
            @font-face{
                font-family:"fasttrack";
                src:url("/fonts/fasttrack.ttf");
            }
            @font-face{
            ...
            @font-face{
                font-family:"trobus";
                src:url("/fonts/TrobusExpanded.ttf");
            }
            ...
            .w-booking .b-btn__book .first-capital{
                font-family:"Blazed";
            }
            .b-header__txt{
                font-family:"trobus"!important;
                font-size:55px;
            }
            .highspeed-font{
                font-family:"highspeed"!important;
            }
            .highspeed-font .rectangle{
                background: black;
                height: 70px;
                transform: rotate(121deg);
                width: 96px;
                border-radius: 0px 30px 0px 170px;
                position: absolute;
                top: 1px;
                left: -28px;
            }
            
            .highspeed-font .lines{
                position: absolute;
                left: 46px;
                top: 17px;
                height: 43px;
            ...
            .highspeed-font .lines .line:nth-child(2){
                width: 140px;
            }
            .highspeed-font .lines .line:nth-child(3){
                width: 130px;
            }
            .highspeed-font .lines .line:nth-child(4){
                width: 140px;
            }
            .highspeed-font::before{
                content:" ";
                width:200px; 
                background:black;
            }
...
.b-btn__book.styled{
    transform: skew(-2deg, 0deg)!important;
...
border-right:2px solid red;
    ...
    <title>Exotics Racing | Toronto Supercar Driving Experience</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description"
        content="The supercar driving experience in Toronto. Drive exotic cars like Ferrari, Lamborghini, Porsche, McLaren and others. Book Now!" />
    <meta name="keywords"
        content="racing school, driving experience, Toronto, ferrari, lamborghini, porsche, aston martin, speedway, attractions, exotics, exotic cars, racing, driving, experience, driving school" />

    <meta name="twitter:card" content="summary" />
    <meta name="twitter:site" content="@ExoticsRacing" />
    <meta name="twitter:title" content="Exotics Racing | Toronto Supercar Driving Experience" />
    ...
    <meta property="og:title" content="Exotics Racing | Toronto Supercar Driving Experience" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebPage",
            "name": "Exotics Racing | Toronto Supercar Driving Experience",
            "description": "The supercar driving experience in Toronto. Drive exotic cars like Ferrari, Lamborghini, Porsche, McLaren and others. Book Now!",
            "publisher": {
                "@type": "Organization",
                "name": "ExoticsRacing"
            }
            ...
            <nav class="w-nav">
                ...
                <div class="logo">    
                        <a href="index.html" class="block">
                            <img 
                            style="height:100px;"
                            src='https://supercarexperiences.ca/wp-content/uploads/elementor/thumbs/cropped-Supercar-Logo-with-white-spray-paint-pfmte0i89vpb7ffe9lzw387jvsr5o4js71h2yxhwpo.png'/>
                        </a>
                </div>
                    <ul id="super-menu" class="b-menu unstyled-list pull-right" >
                        <li class="b-dropdown">
                    ...
                    <div class="w-booking">
                        ...
                        <a id="_menu_book_now" href="driving-experience.html"
            ...
            <div id="slider" class="b-carousel owl-carousel ">
                ...
                <div class="item"><img class="block" style="height:670px;"
                    ...
                    <div class="w-caption bottom-left">
                        <div class="caption">
                            <div class="head"><strong>THE FASTEST AND MOST ENJOYABLE CIRCUIT IN Toronto</strong>
                            </div>
        ...
        <section class="w-experiences">
            ...
            <section class="w-section" style="padding-top: 20px;">
                ...
                <div class='container'>
                      ...
                      <h1 class="highspeed-font" style="border-radius:19px 0px 0px 0px;">CHOOSE YOUR SUPERCAR EXPERIENCE </h1>
                ...
                <form class="" data-ajax="false" id="inlineForm"
                    ...
                    <p>Canada's best rated & fastest growing exotic car company. Drive your dream car with extensive guide from our experts. Enjoy 100% and worry 0% about the driving experience. We have your back. Come drive with us and click on button above the header to book your driving experience with us.  </p>
                </div>
...
<h3 class="title">SUPERCAR DRIVING EXPERIENCES<br />Toronto RACETRACK</h3>
<p>As the original, best rated and world's largest supercar driving experience, we let you drive our fleet of over 40 exotic cars on the fastest and safest racetrack in Toronto.<br />You will be able to drive our supercars coached by our team of friendly experts to have the most exhilarating driving experience ever!<br />No stress, we take care of everything! Technical Briefing, Discovery Laps, Supercars, Lap Times, Private Coaching, Helmets &amp; Insurance. You can aslo add to your experience the On-board Video, a Photo, our famous Drifting Ride-Along or some Go-Kart Races.</p>
<br />
...
<div class="overlay">
<div class="b-promo-content">
<h3 class="title"><g class="gr_ gr_34 gr-alert gr_spell gr_inline_cards gr_run_anim ContextualSpelling ins-del multiReplace" id="34" data-gr-id="34">GO-KART<br />Toronto</g></h3>
<p>Race against your friends with the best go-kart equipment at VEGAS SUPERKARTS! Our brand-new outdoor racetrack ensures high safety and fun for anyone racing with us. There is no other place in Toronto where you can find what we offer, so if you want to race the best go karts, come race with us!</p>
<br />
...
<div style="text-align: center;"><a href="driving-experience-off-road.html" class="btn">Learn More</a></div>
                            ...
                            <div class="elementor-widget-container">
                                <a class="elementor-cta" href="/supercar-track-days">
                                    ...
                                    <div class="elementor-cta__content" style="text-align: center;">
                                        ...
                                        <h2
                                            class="elementor-cta__title elementor-cta__content-item elementor-content-item elementor-animated-item--grow highspeed-font"
                ...
                <div id="experiences-packages-index">
                    ...
                    <div class="w-more__cars">
                        <div class="b-header__sub">
                            <h2 class="b-header__sub-txt highspeed-font" style="background:none; color:black!important;">
                                Is one not <b class="highspeed-font" style="background:none; color:black!important;">enough?</b> </h2>
                        </div>
                        <div class="container">
            ...
            <section class="w-section design-narrow" style="margin-bottom:-128px;">
                <div class="section-head" style="background:black;">
                    <h2 class="highspeed-font" >
                    <div class="rectangle"></div>     
                    <div class="lines">
                    ...
                    <strong class="highspeed-font">The #1 supercar</strong> driving experience</h2>
                                ...
                                <div class="swiper-slide">
                                    <div>
                                        ...
                                        <p>Among our competition, we are the most highly rated supercar driving
                                            ...
                                            we&rsquo;ve won multiple Best of Toronto and TripAdvisor awards over the
                                ...
                                <div class="swiper-slide">
                                    <div>
                                        ...
                                        <p>Take part of the world's largest motorsports competition, exclusively at
                                            Exotics Racing Toronto. Whether you want to race against the clock or a
                                ...
                                <div class="swiper-slide">
                                    <div>
                                        ...
                                        <p>Our exclusive racetrack is located at Speed Vegas. There&nbsp;are also the
                                            fastest go-kart track &amp; Off-Road track in Toronto opened 7 days a
                                            week.</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row" style="background:#000000b8;">
                    ...
                    ">
                        ...
                        ">
                            ...
                            <p>    
                            Track Days are the most exhilarating and heart-pumping experience we offer. Our clients, (under the careful eyes of our racing coaches) can push our exotic cars without speed limiters! All you need is a G1 license or international license to participate and live your dreams. We provide the longest racetrack experience at 2.2KMs each lap.
                                    </p><p>
                            We host our track days at Canadian Tire Motorsport Park in Bowmanville and Grand Bend Raceway in Grand Bend. We run rain or shine! No matter the track, you will have an experience of a lifetime. Join us at Canadian Tire Motorsport Park or Grand Bend Raceway for an adrenaline-filled day. Step into the seat of some of the fastest production vehicles ever made and strap yourself in.
                                    </p>
                              </div>
                        ...
                        >
                                   <p style='margin-left:177px;'>
                                    ...
                                    style="
                                        ...
                                        background: url(https://supercarexperiences.ca/wp-content/uploads/2021/11/Supercars-244-600x500-overlay.jpg);
                                        transform: skew(0deg, 8deg);
                                        box-shadow: -28px -30px 2px -17px red, 26px 27px 2px -17px red;
                                        border: 0px;
                                        height: 170px;
                                            "
                                    >BOOK YOUR TRACK LAPS TODAY!</button>
                                    </p>
                        </div>
                ...
                <div class="row" style="background:#000000b8;">
                        ...
                        >
                                   <p style='margin-left:177px;'>
                                    ...
                                    style="
                                        width: 200px;
                                        background-size: cover!important;
                                        background: url('https://supercarexperiences.ca/wp-content/uploads/2021/11/Supercars-233-600x500-overlay.jpg');
                    ...
                    ">
                        ...
                        ">
                            ...
                            <div class="w-text " style="">
                            <p>Imagine driving 4-5 supercars through beautiful forest drives and incredible snake roads. Welcome to our Tour Days. This is the best way to experience and get behind the wheel of a variety of exotic cars. We include fuel for all the supercars. A delicious lunch is included in the Grand Tour. We also provide 100-200 photos and a personalized movie with DSLR/Drone/GoPro footage as part of your package. Our tour movie is second to none! It will knock your socks off and be sure to impress, as you share it amongst your family & friends.

                            </p>
                                    <p>
                            Come experience the hype and explore the backroads of Halton Hills. We take care of the depreciation, gas, maintenance, and insurance of these exotic cars; You experience all the fun and DRIVE! The price is per seat. Whether you come, solo, with a friend, or with a team... The tours will have you leaving Supercar Experiences with everlasting memories and a smile that never fades when you reminisce on it.
                           </p>
                ...
                <div class="row" style="background:#000000b8;">
                    ...
                    ">
                        ...
                        ">
                            ...
                            <div class="w-text " style="">
                           <p> Looking for an exotic car rental that reflects your special occasion? We are the ideal destination for exotic cars in Toronto and expanding across the GTA. Supercar Experiences has an extensive range of exotic cars in pristine condition and at affordable rates. Pick from a wide variety of supercars such as Lamborghini, Ferrari, McLaren, Audi, Porsche, Rolls Royce and more!
                            </p>
                            <p>A chance to experience the world’s greatest exotic cars without all the hassles and expense of ownership! We ask that you have a valid G2 driver's license at minimum and a copy of your own insurance. Our exotic cars require deposits that range from 5K-10K. It is a hold to make sure the supercar returns safely. You get 200KMs for the day and the rental hours are from 10AM - 9AM. This gives us an hour to clean and detail the car for the next client. We're here to make make your day extraordinary! Now, we know it won't be easy, but which exotic car are you choosing? The decision is in your hands...
                            </p>
                            </div>
                            {{-- <div class="w-btn"><a class="btn-inver-white" href="media/tab/hall-of-fame.html">celebrities</a> <a class="btn-inver-white" href="media/tab/photos.html">photos</a> <a class="btn-inver-white" href="media/tab/videos.html">videos</a><a class="btn-inver-white" href="media.html">media</a></div>
</div> --}}
                ...
                <div class="row" style="background:#000000b8;">
                        ...
                        >
                                   <p style='margin-left:177px;'>
                                    ...
                                    style="
                                        ...
                                        height: 170px;
                                            "
                                    >CALL TO BOOK PRIVATE DRIVES</button>
                                    </p>
                        </div>
                    ...
                    ">
                        ...
                        ">
                            ...
                            <div class="w-text " style="">
                           <p> This is an experience we offer on the regular and we believe it is as a great introduction to the world of exotic cars. These private drives are a fantastic way to treat yourself or take your significant other on a pleasant shared driving experience. We offer 30-minute test drives or 1-hour private drives. 30-min test drive, the route is built around lakeshore. The 1 HR private drive will present you with the ability to reach Halton hills and have access to some of our scenic tour locations with forest drives and snake roads. It is definitely a must see!
                            </p>
                            <p>
                            Best part? No deposit required! We take care of the hassle, while you have all the fun. If you are coming solo, we will sit passenger to guide you around the route. However, If there is a passenger coming with you; we will be in a lead car to take you around. Drivers must have a valid G2 license. Out-of-country licenses are also accepted. To book this in, please call us 24 hours prior or the day of. Our exotic cars are usually gone for rentals. This way you can check the availability and see if you specific supercar is present. Please reach us at 416-900-1102.
                            </p>
                            </div>
                            {{-- <div class="w-btn"><a class="btn-inver-white" href="media/tab/hall-of-fame.html">celebrities</a> <a class="btn-inver-white" href="media/tab/photos.html">photos</a> <a class="btn-inver-white" href="media/tab/videos.html">videos</a><a class="btn-inver-white" href="media.html">media</a></div>
</div> --}}
                    ...
                    <div class='col-lg-12' 
                    style='background:#ff00009c; 
                    height:50px; 
                    text-align:center;'>
                    <h2 class="highspeed-font" style='margin-left:0px!important;background:none!important;'>Our Satisfied Customers</h2>

                    </div>
            </section>
            <!-- DATA Item code page-block-homepage-reviews -->
            <section class="w-reviews" style='
             
            background:url(https://supercarexperiences.ca/wp-content/uploads/2021/11/Supercar-Pics-600x500-1.jpg);
           ...
           background-size:cover;
            ...
            '>
                <!-- <div class="section-head">
                     ...
                     <div class="row" style='background-color:#ff00009c;'> 
                            ...
                            <figure><img class="ava"
                                ...
                                <figcaption>
                                    ...
                                    <div class="review">&laquo; Super stage de pilotage sur un circuit incroyable!
                                        ...
                                        cette exp&eacute;rience a tous ceux qui passent par tronto, vous ne vivrez ca
    ...
    <footer
        ...
        <div class="row" style="background:#fffffff0;">
            ...
            <div class="container">
                ...
                <!--search-panel-->
                <div class="footer-menu" style="padding-left:0px;">
                    <div class="row m-0 p">
