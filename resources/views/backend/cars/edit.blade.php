...
@section('content')
    <x-forms.post :action="route('update_cars',$id)" enctype="multipart/form-data">
        <x-backend.card>
            <x-slot name="header">
                Edit Cars
            </x-slot>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="title" class="form-control" placeholder="Enter Title"
                                   value="{{ $car->title }}" maxlength="100" required />
                        </div>
                    </div>
                    <!--form-group-->
                        ...
                        <div class="col-md-10">
                            ...
                            <select name="model" class="form-control" required
                                ...
                                @foreach($modals as $key=>$modal)
                                    <option
                                    value="{{$modal->id}}" {{ $car->model == $modal->id ? 'selected="selected"' : ''}}>{{$modal->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="number" name="top_speed" class="form-control" placeholder="Enter Top Speed"
                                   value="{{ $car->top_speed }}" maxlength="999" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="number" name="power" class="form-control" placeholder="Enter Hourse Power of the Car"
                                   value="{{ $car->power }}" maxlength="999" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="accelaration_time" class="form-control" placeholder="Enter Accelaration Time"
                                   value="{{ $car->accelaration_time }}" maxlength="999" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="price" class="form-control" placeholder="Enter Price"
                                   value="{{ $car->price }}" maxlength="999" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="accelaration" class="form-control" placeholder="Enter Accelaration"
                                   value="{{ $car->accelaration }}" maxlength="999" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="control" class="form-control" placeholder="Enter Control/Suspetion/Stearing Response"
                                   value="{{ $car->control }}" maxlength="999" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="number" name="overall" class="form-control" placeholder="Enter Overall Performance"
                                   value="{{ $car->overall }}" maxlength="999" required />
                        </div>
                    </div>
                            ...
                            <div class="db">
                                ...
                                <div>
                                    <img id="imagePreview1"
                                         ...
                                         src="{{(isset($car->image) && !empty($car->image)) ? asset("uploads/cars/$car->image") : asset('uploads/cars/default.png') }}"/>
                                </div>
                            </div>
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">Update Car</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
