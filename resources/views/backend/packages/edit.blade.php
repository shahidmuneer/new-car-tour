...
@section('content')
    <x-forms.post :action="route('update_package',$id)" enctype="multipart/form-data">
        <x-backend.card>
            <x-slot name="header">
                Edit Package
            </x-slot>
            ...
            <x-slot name="body">
                <div x-data="{ userType: '{{ $model::TYPE_USER }}' }">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="title" class="form-control" placeholder="Enter Title"
                                   value="{{ $package->title }}" maxlength="100" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="number_of_cars" class="form-control" placeholder="Enter Number of Cars"
                                   value="{{ $package->number_of_cars }}" maxlength="100" required />
                        </div>
                    </div>
                    <!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="available_times" class="form-control" placeholder="Enter Available Time Slots Per Day"
                                   value="{{ $package->available_times }}" maxlength="100" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="single_seat_price" class="form-control" placeholder="Enter Single Seat Price"
                                   value="{{ $package->single_seat_price }}" maxlength="100" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="double_seat_price" class="form-control" placeholder="Enter Double Seat Price"
                                   value="{{ $package->double_seat_price }}" maxlength="100" required />
                        </div>
                    </div>
                    <!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="guarranttee_car_price" class="form-control" placeholder="Enter Guarrenttee Seat Price"
                                   value="{{ $package->guarranttee_car_price }}" maxlength="100" required />
                        </div>
                    </div>
                    <!--form-group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="insurance_price" class="form-control" placeholder="Enter Insurance Price"
                                   value="{{ $package->insurance_price }}" maxlength="100" required />
                        </div>
                    </div>
                    <!--form-group-->
                    ...
                    <div class="form-group row" style="margin-bottom:90px;">
                        ...
                        <div class="col-md-10">
                            <div id="aboutEditor">{!! $package->about !!}</div>
                            <textarea name="about" class="form-control"
                                      style="display:none;"
                                      id="aboutInput"
                                      placeholder="Enter About">{{ $package->about }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="margin-bottom:90px;">
                        ...
                        <div class="col-md-10">
                            <div id="hightlightsEditor">{!! $package->highlights !!}</div>
                            <textarea name="highlights" class="form-control"
                                      style="display:none;"
                                      id="highlightsInput"
                                      placeholder="Enter Highlights">{{ $package->highlights }}</textarea>
                        </div>
                    </div>
                            ...
                            <div class="db">
                                ...
                                <div>
                                    <img id="imagePreview1"
                                         ...
                                         src="{{(isset($package->image) && !empty($package->image)) ? asset("uploads/cars/$package->image") : asset('uploads/cars/default.png') }}"/>
                                </div>
                            </div>
...
{{--                    </div>--}}
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">Update Package</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
