...
@section('content')
    <x-forms.post :action="route('packageprice.store')">
        <x-backend.card>
            <x-slot name="header">
            ...
            <x-slot name="headerActions">
                <x-utils.link class="card-header-action" :href="route('packageprice.index')" :text="__('Cancel')" />
            </x-slot>
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">Create Package Price</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
@endsection
