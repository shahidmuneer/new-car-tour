    ...
    <ul class="c-sidebar-nav">
        ...
        @if ($logged_in_user->hasAllAccess())
            <li class="c-sidebar-nav-dropdown">
                <x-utils.link href="#" icon="c-sidebar-nav-icon cil-list" 
            ...
            <li class="c-sidebar-nav-item">
                        <x-utils.link :href="route('modals.index')" 
                        icon="c-sidebar-nav-icon cil-casino" 
                        class="c-sidebar-nav-link" :text="__('Car Modals')" />
            </li>

            <li class="c-sidebar-nav-item">
                        <x-utils.link :href="route('cars.index')" 
                        icon="c-sidebar-nav-icon cil-car-alt" 
                        class="c-sidebar-nav-link" :text="__('cars')" />
            </li>

            <li class="c-sidebar-nav-item">
                        <x-utils.link 
                        
                        icon="c-sidebar-nav-icon cil-hot-tub" 
                        :href="route('plans.index')" class="c-sidebar-nav-link" :text="__('Plan')" />
            </li>
            ...
            <li class="c-sidebar-nav-item">
                        ...
                        :href="route('packages.index')" class="c-sidebar-nav-link" :text="__('package')" />
            </li>

            <li class="c-sidebar-nav-item">
                        <x-utils.link 
                        icon="c-sidebar-nav-icon cil-history" 
                        :href="route('packagecategory.index')" class="c-sidebar-nav-link" :text="__('package category')" />
            </li>
            
                    <li class="c-sidebar-nav-item">
                        <x-utils.link 
                        icon="c-sidebar-nav-icon cil-dollar" 
                        :href="route('packageprice.index')" class="c-sidebar-nav-link" :text="__('package price')" />
                    </li>
        @endif
    </ul>
